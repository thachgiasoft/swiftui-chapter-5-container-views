...
extension BothDirectionScroll_Previews {
    @_dynamicReplacement(for: previews) private static var __preview__previews: some View {
        ...
        AnyView(__designTimeSelection(BothDirectionScroll(), "#18827.[2].[0].property.[0].[0]"))
#sourceLocation()
    }
}
...
extension BothDirectionScroll {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        AnyView(__designTimeSelection(ScrollView([.vertical, .horizontal]){
            __designTimeSelection(Image(__designTimeString("#18827.[1].[0].property.[0].[0].arg[1].value.[0].arg[0].value.[0].value", fallback: "Marmaris")), "#18827.[1].[0].property.[0].[0].arg[1].value.[0]")
        }, "#18827.[1].[0].property.[0].[0]"))
#sourceLocation()
    }
}
